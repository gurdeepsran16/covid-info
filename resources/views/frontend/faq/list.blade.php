    ...
    <div class="card-body p-10 p-lg-15">
        ...
        <div class="mb-13">
            ...
            <div class="mb-15">
                ...
                <!--end::Title-->
                <!--begin::Text-->
                <p class="fw-bold fs-4 text-gray-600 mb-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                <!--end::Text-->
            </div>
            <!--end::Intro-->
            <!--begin::Row-->
            <div class="row mb-12">
                ...
                <div class="col-md-6 pe-md-10 mb-10 mb-md-0">
                    <!--begin::Title-->
                    <h2 class="text-gray-800 fw-bolder mb-4">Covid Variant</h2>
                    <!--end::Title-->
                    <!--begin::Accordion-->
                    <!--begin::Section-->
                    <div class="m-0">
                ...
                <div class="col-md-6 ps-md-10">
                    <!--begin::Title-->
                    <h2 class="text-gray-800 fw-bolder mb-4">Vaccine</h2>
                    <!--end::Title-->
                    <!--begin::Accordion-->
                    <!--begin::Section-->
                    <div class="m-0">
            ...
            <div class="row">
                ...
                <div class="col-md-6 pe-md-10 mb-10 mb-md-0">
                    <!--begin::Title-->
                    <h2 class="text-gray-800 w-bolder mb-4">Dummy</h2>
                    <!--end::Title-->
                    <!--begin::Accordion-->
                    <!--begin::Section-->
                    <div class="m-0">
                ...
                <div class="col-md-6 ps-md-10">
                    <!--begin::Title-->
                    <h2 class="text-gray-800 fw-bolder mb-4">Dummy</h2>
                    <!--end::Title-->
                    <!--begin::Accordion-->
                    <!--begin::Section-->
                    <div class="m-0">
